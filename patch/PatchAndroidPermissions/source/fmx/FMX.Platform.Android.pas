...
procedure TFMXNativeActivityListener.onRequestPermissionsResult(requestCode: Integer; permissions: TJavaObjectArray<JString>;
  grantResults: TJavaArray<Integer>);
var
  Msg: TMessageResultPermissions;
begin
  Msg := TMessageResultPermissions.Create(requestCode);
  Msg.Permissions := permissions;
  Msg.GrantResults := grantResults;
  TMessageManager.DefaultManager.SendMessage(nil, Msg);
end;
