...
// ===== Forward declarations =====
  ...
  JFMXTimer = interface;//com.embarcadero.firemonkey.timer.FMXTimer
  JFMXTimerListener = interface;//com.embarcadero.firemonkey.timer.FMXTimerListener
...
// ===== Interface declarations =====
  ...
  JFMXTextEditorProxyClass = interface(JViewClass)
    ...
    {class} function _GetINPUT_NUMBER_DECIMAL: Integer; cdecl;
    ...
    {class} function _GetCHARCASE_NORMAL: Integer; cdecl;
    {class} function _GetCHARCASE_UPPER: Integer; cdecl;
    {class} function _GetCHARCASE_LOWER: Integer; cdecl;
    ...
    {class} property INPUT_NUMBER_DECIMAL: Integer read _GetINPUT_NUMBER_DECIMAL;
    ...
    {class} property CHARCASE_NORMAL: Integer read _GetCHARCASE_NORMAL;
    {class} property CHARCASE_UPPER: Integer read _GetCHARCASE_UPPER;
    {class} property CHARCASE_LOWER: Integer read _GetCHARCASE_LOWER;
  end;
  ...
  JFMXTextEditorProxy = interface(JView)
    ...
    procedure setCharCase(value: Integer); cdecl;
    procedure setFilterChar(value: JCharSequence); cdecl;
  end;
  ...
  JFMXTimerClass = interface(JTimerClass)
    ['{410F84DB-BBEA-4762-B59E-F30341F85718}']
    {class} function init(listener: JFMXTimerListener; activity: JActivity): JFMXTimer; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/timer/FMXTimer')]
  JFMXTimer = interface(JTimer)
    ['{0246C834-11AE-4910-820D-186B985F848F}']
    procedure scheduleAtFixedRate(delay: Int64; period: Int64); cdecl;
    procedure setListener(listener: JFMXTimerListener); cdecl;
    procedure setHandle(handle: Integer); cdecl;
  end;
  TJFMXTimer = class(TJavaGenericImport<JFMXTimerClass, JFMXTimer>) end;

  JFMXTimerListenerClass = interface(IJavaClass)
    ['{562C845F-64F8-4F9E-9808-0342CC7B1EA8}']
  end;

  [JavaSignature('com/embarcadero/firemonkey/timer/FMXTimerListener')]
  JFMXTimerListener = interface(IJavaInstance)
    ['{8441F8D7-8592-4E02-848C-8BAE201E4209}']
    procedure onTimer(handle: Integer); cdecl;
  end;
  TJFMXTimerListener = class(TJavaGenericImport<JFMXTimerListenerClass, JFMXTimerListener>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JFMXTimer', TypeInfo(Androidapi.JNI.Embarcadero.JFMXTimer));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JFMXTimerListener', TypeInfo(Androidapi.JNI.Embarcadero.JFMXTimerListener));
